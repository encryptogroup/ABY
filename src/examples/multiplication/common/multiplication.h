/**
 ...
 \brief		Implementation of the MULTIPLICATION  using ABY Framework.
 */

#ifndef __MULTIPLICATION_H_
#define __MULTIPLICATION_H_
...
/**
 ...
 \brief		This function is used for running a testing environment for solving a simple multiplication
 */
int32_t test_multiplication_circuit(e_role role, const std::string& address, uint16_t port, seclvl seclvl,
...
/**
 ...
 \brief		This function is used to build and solve the multiplication.
 */
share* BuildMultiplicationCircuit(share *s_alice, share *s_bob,
		ArithmeticCircuit *ac);


#endif /* __MULTIPLICATION_H_ */
